...
Pod::Spec.new do |s|
  ...
  s.author             = { "Detailscool" => "496389006@qq.com" }
  # Or just: s.author    = "Detailscool"
  # s.authors            = { "Detailscool" => "496389006@qq.com" }
  # s.social_media_url   = "http://twitter.com/Detailscool"
